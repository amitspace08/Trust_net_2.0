        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            <p className="text-xs text-gray-500 mb-2">
              Here is the list of all registered users in your Firestore database. Copy an email
              below and paste it into the search box on the "Add Contact" page.
            </p>
            {users.map((u, i) => (
              <div
                key={u.id || i}
                className="border border-gray-150 rounded-xl p-3 bg-gray-50 flex flex-col gap-1"
              >
                ...
                <p className="text-xs font-semibold text-gray-900">
                  Email (field `email`):{" "}
                  <span className="font-normal text-gray-700">{u.email || "N/A"}</span>
                </p>
                <p className="text-xs font-semibold text-gray-900">
                  Email (field `email_id`):{" "}
                  <span className="font-normal text-gray-700">{u.email_id || "N/A"}</span>
                </p>
                <p className="text-xs font-semibold text-gray-900">
                  Phone (field `phone_no`):{" "}
                  <span className="font-normal text-gray-700">{u.phone_no || "N/A"}</span>
                </p>
                <p className="text-xs font-semibold text-gray-900">
